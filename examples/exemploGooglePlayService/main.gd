...
func _ready():
	...
	google.increse_achievement("achievementID", int(2)) # increse achievements by step.
	google.show_achievements() # show achievements;
	
	#Google play Leaderboards
	google.submit_leaderboard(int(234), "leaderboardID") # submit score to leaderboard
