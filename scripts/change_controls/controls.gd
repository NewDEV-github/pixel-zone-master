...
# Constants
const INPUT_ACTIONS = [ "move_up", "move_down", "move_left", "move_right", "jump", "ui_accept", "ui_select", "ui_cancel", "ui_focus_next", "ui_focus_prev", "ui_left", "ui_right", "ui_uop", "ui_down", "ui_page_up", "ui_page_down", "ui_home", "ui_end", "shoot", "speed", "shortcut_action"]
