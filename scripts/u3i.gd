...
func _process(delta):
	if $GameUI/UIScaler/Menu/OptionsPage/TabContainer/Theme/VBoxContainer/CheckButton.pressed == true:
		ProjectSettings.set("gui/theme/custom", ui_theme)

func _ready():
	$GameUI/UIScaler/Menu/OptionsPage/TabContainer/Theme/VBoxContainer/CheckButton.pressed
